package com.as.controller.system.createcode;
...
import com.as.service.system.createcode.CreateCodeManager;
import com.as.util.AppUtil;
import com.as.util.DateUtil;
import com.as.util.DelAllFile;
import com.as.util.FileDownload;
import com.as.util.FileZip;
import com.as.util.Freemarker;
import com.as.util.Jurisdiction;
import com.as.util.PageData;
import com.as.util.PathUtil;
...
public class CreateCodeController extends BaseController {
	...
	public void proCode(HttpServletResponse response) throws Exception{
		...
		for(int i=0; i< zindex; i++){
			fieldList.add(pd.getString("field"+i).split(",as,"));	//属性放到集合里面
		}
	...
	public void save(PageData pd) throws Exception{
		...
		pd.put("TABLENAME", pd.getString("tabletop")+",as,"+pd.getString("objectName").toUpperCase());	//表名
