...
public class Dimentions {
	...
	private String DIMENTIONS_ID;	//主键
	private String target;
	private Dimentions dict;
	private List<Dimentions> subDict;
	...
	public Dimentions getDict() {
		return dict;
	}
	public void setDict(Dimentions dict) {
		this.dict = dict;
	}
	public List<Dimentions> getSubDict() {
		return subDict;
	}
	public void setSubDict(List<Dimentions> subDict) {
