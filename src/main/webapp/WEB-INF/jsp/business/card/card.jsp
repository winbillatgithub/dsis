...
<body>
 <div class="container">
 	...
 	<div class="col-xs-3">
 	<div ><h3>控件面板</h3></div>
	<ul id="left1" class="left cpList frmb-control sort-enabled ui-sortable">
	    <li id="left_wb icon-text input-control input-control-9 ui-sortable-handle" itemType="left_wb" class="liClass">文本</li>
	    <li id="left_zs"   itemType="left_zs" class="liClass">整数</li>
	    <li id="left_xs"   itemType="left_xs" class="liClass">小数</li>
	    <li id="left_dx"   itemType="left_dx" class="liClass"><img src="/static/resource/img/check.JPG" style="width:100%;height:100%" /></li>
	    <li id="left_dx1"   itemType="left_dx" class="liClass"><img src="/static/resource/img/radio.JPG" style="width:100%;height:100%" /></li>
 	...
 	<ul id="right">
	    ...
	    <li class="liClass">
	    	<select id="itemTypeValue" class="propertyInput" disabled>
              ...
              <option value="left_dx">多选框</option>
