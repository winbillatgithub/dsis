 ...
 */	
	...
	function saveD(){
		...
		var fields = dname + ',as,' + dtype + ',as,' + dbz + ',as,' + isQian + ',as,' + ddefault + ',as,' + flength;;
	...
	function editField(value,msgIndex){
		$("#dialog-add").css("display","block");
		var efieldarray = value.split(',as,');
	...
	function isSame(value){
		for(var i=0;i<arField.length;i++){
			var array0 = arField[i].split(',as,')[0];
			if(array0 == value){
				return false;
			}
		}
