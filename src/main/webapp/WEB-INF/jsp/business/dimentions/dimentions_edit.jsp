		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="/dimentions/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="DIMENTIONS_ID" id="DIMENTIONS_ID" value="${pd.DIMENTIONS_ID}"/>
						<input type="hidden" name="PARENT_ID" id="PARENT_ID" value="${null == pd.PARENT_ID ? DIMENTIONS_ID:pd.PARENT_ID}"/>
						<div id="zhongxin">
