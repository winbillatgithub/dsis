	...
	<script type="text/javascript">
		...
		function parentReload(){
			if(null != '${MSG}' && 'change' == '${MSG}'){
				parent.location.href="/menu/listAllMenu.do?MENU_ID="+${MENU_ID};
			}
		}
		parentReload();
	</script>
...
<body class="no-skin">
	...
	<script type="text/javascript">
		...
		function editmenu(MENU_ID){
			if (typeof top.jzts === "function") {top.jzts();}
			window.location.href="/menu/toEdit.do?id="+MENU_ID;
		};
		...
		function delmenu(MENU_ID){
			bootbox.confirm("确定要删除此菜单吗?", function(result) {
				if(result) {
					var url = "/menu/delete.do?MENU_ID="+MENU_ID+"&guid="+new Date().getTime();
					if (typeof top.jzts === "function") {top.jzts();}
