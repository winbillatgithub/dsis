...
$.fn.uploadAdapter = function(opts){
	...
	defaults.swf = '/static/uploadAdapter/uploadify/uploadify.swf';
	...
	var setLoaderValue = function(type){
		if(type=='html5'){
			...
			jsUrl = '/static/uploadAdapter/Huploadify/jquery.Huploadify.js';
			cssUrl = '/static/uploadAdapter/Huploadify/Huploadify.css';
		}
		else{
			pluginName = 'uploadify';
			jsUrl = '/static/uploadAdapter/uploadify/jquery.uploadify.min.js';
			cssUrl = '/static/uploadAdapter/uploadify/uploadify.css';
		}
	}
