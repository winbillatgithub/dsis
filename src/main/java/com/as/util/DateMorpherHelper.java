...
import net.sf.ezmorph.object.AbstractObjectMorpher;
 ...
 public class DateMorpherHelper extends AbstractObjectMorpher {
     ...
     private Date defaultValue;
       ...
       public DateMorpherHelper(String[] formats)
       {
         this(formats, Locale.getDefault(), false);
       }
 
       public DateMorpherHelper(String[] formats, boolean lenient)
       {
         this(formats, Locale.getDefault(), lenient);
       }
 
       public DateMorpherHelper(String[] formats, Date defaultValue)
       {
         this(formats, defaultValue, Locale.getDefault(), false);
       }
 
       public DateMorpherHelper(String[] formats, Date defaultValue, Locale locale, boolean lenient)
       {
         super(true);
       ...
       public DateMorpherHelper(String[] formats, Locale locale)
       {
         this(formats, locale, false);
       }
 
       public DateMorpherHelper(String[] formats, Locale locale, boolean lenient)
       {
         if ((formats == null) || (formats.length == 0)) {
           throw new MorphException("invalid array of formats");
         }
       ...
       public boolean equals(Object obj)
       {
         ...
         if (!(obj instanceof DateMorpherHelper)) {
           return false;
         }
 
         DateMorpherHelper other = (DateMorpherHelper)obj;
