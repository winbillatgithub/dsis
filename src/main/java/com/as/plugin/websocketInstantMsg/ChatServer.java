package com.as.plugin.websocketInstantMsg;
...
public class ChatServer extends WebSocketServer{
	...
	public void onMessage(WebSocket conn, String message){
		...
		if(null != message && message.startsWith("FHadminqq609281718")){
			this.userjoin(message.replaceFirst("FHadminqq609281718", ""),conn);
		}if(null != message && message.startsWith("LeaveFHadminqq609281718")){
			this.userLeave(conn);
