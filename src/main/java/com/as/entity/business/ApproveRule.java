...
public class ApproveRule {
	...
	private String APPROVERULE_ID;	//主键
	private String CORP_ID;			//组织ID
	private String target;
	private ApproveRule dict;
	private List<ApproveRule> subDict;
	...
	public String getAPPROVERULE_ID() {
		return APPROVERULE_ID;
	}
	public void SetAPPROVERULE_ID(String dIMENTIONS_ID) {
		APPROVERULE_ID = dIMENTIONS_ID;
	}
	...
	public ApproveRule getDict() {
		return dict;
	}
	public void setDict(ApproveRule dict) {
		this.dict = dict;
	}
	public List<ApproveRule> getSubDict() {
		return subDict;
	}
	public void setSubDict(List<ApproveRule> subDict) {
